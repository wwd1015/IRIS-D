...
from .components.vintage_analysis import create_vintage_analysis_sidebar, create_vintage_analysis_content, create_quarterly_cohort_chart
from .components.portfolio_trend import create_portfolio_trend_sidebar, get_portfolio_metrics, create_portfolio_trend_content, create_portfolio_trends_charts
from .components.sir_analysis import create_sir_analysis_sidebar, create_sir_analysis_content
from .components.location_analysis import create_location_analysis_sidebar, create_location_analysis_content
from .components.financial_projection import create_financial_projection_sidebar, create_financial_projection_content
from .components.model_backtesting import create_model_backtesting_sidebar, create_model_backtesting_content
from .components.financial_trends import create_financial_trend_sidebar, create_financial_trend_content, create_financial_trend_details_table
...
def update_main_content(selected_portfolio):
    if selected_portfolio is None:
        selected_portfolio = default_portfolio
    return create_main_content(selected_portfolio, lambda p: get_filtered_data(p, portfolios, latest_facilities), facilities_df, portfolios)
